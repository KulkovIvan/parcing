...
class InstagramSpider(scrapy.Spider):
    ...
    inst_login = 'doofy13'
    inst_pwd = '#PWD_INSTAGRAM_BROWSER:10:1637240427:AchQAJb/6IF+Kcrtzy9ldJwooK7RavY7wRRc2b5k2knHtBsBk1Cdg+kMU/52oy40J/ykno0euQqQgQscvTbQXCyHhtwXU0xWyHnP4Jot54zW0am5tC9L6TKiiMznzaPNxlOLx4OXVmT9Wo='
    users_for_parse = ['ann1994.15', 'deny_g_u']
            ...
            if j_data.get('authenticated'):
                for user_for_parse in self.users_for_parse:
                    for part in self.partitions:
                        yield response.follow(f'/{user_for_parse}', callback=self.following_user_parse,
                                                        cb_kwargs={'username': user_for_parse,'part': part})
